...
\begin{cventries}
  ...
  \cventry
    ...
    {June 2019 - Jan. 2021} % Date(s)
    {
      ...
      \item {Created a web app for searching/downloading data (stored in the cloud) collected from fleets of autonomous vehicles around the world (utilizing Flask, and various AWS services).}
      \end{cvitems}
    }
