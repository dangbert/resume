...
\begin{cvskills}
  ...
  \cvskill
    ...
    {React, Node.js, Flask, Docker, Apache, NGINX, ROS, Android Studio, Git, SVN.} % Skillset

  \cvskill
    {Cloud Technologies} % Type
    {\underline{AWS}: EC2, S3, Elastic Beanstalk, Lambda, Step Functions. \underline{Google Cloud}: App Engine.  Terraform.} % Skillset
